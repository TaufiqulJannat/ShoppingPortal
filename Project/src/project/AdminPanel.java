...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Electronics", "Clothes", "Kids" }));
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Electronics", "Clothes", "Kids" }));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Electronics", "Clothes", "Kids" }));
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        // TODO add your handling code here:
        try{
            if(mCat.getSelectedItem().equals("Cloaths")){
            if(!path.equals(""))
                CloathsDB.insertIntoCloathsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            else if(stockStatusCat.getSelectedItem().equals("Cloaths")){
                CloathsDB.flag = true;
                CloathsDB.updateCloathsDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        else if(delUpdateCat.getSelectedItem().equals("Cloaths")){
            CloathsDB.delete(del);
        }
